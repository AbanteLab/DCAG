...
- [data_preprocessing/](data_preprocessing): Initial exploration of Handsaker et al. (2025) raw data, and assembly of datasets.
- [model_training/](model_training/): Source code for model training with Pyro and scANVI.
- [model_evaluation/](model_evaluation/): Exploration of model results.
